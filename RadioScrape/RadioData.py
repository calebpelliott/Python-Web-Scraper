class RadioData:
    ...
    def returnAllDataDbFormat(self):
        data = (self.callSign, self.callSignURL, self.hasInfo, self.infoURL, self.hasBitcast, self.bitcastURL, self.freqNum, self.am_fm, self.city, self.cityURL, self.school, self.format, self.state)
        return (data)
